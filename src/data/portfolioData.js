...
export const projects = [
  {
    ...
    description: 'Este es mi landing como profesional freelance (Automatizador de procesos empresariales con IA).',
    image: portadaPortafolio,
    imageAlt: 'Landing Freelance',
    preview: 'https://santicoronel-ai.vercel.app/',
    repo: 'https://github.com/Hever2000/LandingSantiCoronelAI',
    stackLabel: 'Stack Landing Freelance',
    stackIcons: [
    ],
  },
  {
  ...
  {
    title: 'Procesador de facturas automatico con IA',
    description: 'Sistema autónomo de procesamiento de facturas mediante el uso de IA para la extracción y análisis de información (Formato de imagen o PDF). Posterior guardado en excel o base de datos, con posibilidad de integración con ERPs, CRMs, etc.',
    image: leads,
    imageAlt: 'Procesador de Facturas',
    preview: '#',
    repo: '#',
    stackLabel: 'Stack Procesador de Facturas',
    stackIcons: [
    ],
  },
